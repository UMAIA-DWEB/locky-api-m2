// dados partilhados entre seed manual (force:true) e auto-seed do server arrancar
...
function buildLockersData(stations) {
  const lockersData = [];
...
function buildReservationsData(users, lockers) {
